...
%Go to www.menti.com and use the code 8880 0203
%\end{frame}
...
The \textit{support points} (marked with diamonds) are the only ones that determine the orientation of the margin.
...
%\begin{figure}
%\includegraphics[height=3cm]{../figures/week_2_classification/bagging.pdf}  
%\end{figure} 
%\end{minipage}\hfill
%\begin{minipage}{0.5\textwidth}
%\begin{itemize}
...
%\begin{minipage}{0.5\textwidth}
%\begin{figure}[H]
%\includegraphics[height=4cm]{../figures/week_2_classification/Bias-Variance-Tradeoff.png}  
%\end{figure} 
%\end{minipage}\hfill
%\begin{minipage}{0.5\textwidth}
%\begin{itemize}
...
%\begin{minipage}{0.5\textwidth}
%\begin{figure}[Ht]
%\includegraphics[height=4.5cm]{../figures/week_2_classification/random-forest.pdf}  
%\end{figure} 
%\end{minipage} \hfill
